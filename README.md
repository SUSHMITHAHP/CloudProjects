...
Upon successful completion of the experiment, the algorithm predicts the closest matching sequence and the subsequent element based on the provided training sequences. In addition to it, to track all executed experiments, the event is also recorded in the 'outputtable.' There is only one ```outputtable``` table and  the data columns of the table are described as follows:
...
- PartitionKey: The partition key for the Azure Table entity.
- RowKey: The row key for the Azure Table entity.
- Timestamp: The timestamp for the Azure Table entity.
- ETag: The ETag for the Azure Table entity, used for concurrency control.
- ExperimentId: The unique identifier for the experiment.
- Name: The name of the experiment.
- Description: A brief description of the experiment.
- StartTimeUtc: The start time of the experiment in UTC.
- EndTimeUtc: The end time of the experiment in UTC.
- DurationSec: The duration of the experiment in seconds.
- InputFileUrl: The URL of the input file used in the experiment.
- OutputFiles: An array of URLs for the output files generated by the experiment.
- Accuracy: The accuracy of the experiment's results.
- Duration: The total duration of the experiment.
- OutputFileUrl: The URL of the primary output file generated by the experiment.
...
On the other hand, the fields of the Experiments Results Table is presented in a tabular format as below - 

- Experiment Id: ID of the experiment
- Name:	Name of the experiment
- Description: User description
- Input file: Input file used for the experiment.
- useSoftmax: If `True` the system uses Softmax Algorithm else if `False` the system uses a Simple Weightage Algorithm.
